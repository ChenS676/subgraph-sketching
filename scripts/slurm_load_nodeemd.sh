...
python runners/run.py --dataset_name ogbn-arxiv --model ELPH  --use_text True --wandb_group reconstruct --epochs 100
python runners/run.py --dataset_name ogbn-arxiv --model ELPH  --use_text False --wandb_group reconstruct --epochs 100
